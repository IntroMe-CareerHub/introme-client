...
const Developer = forwardRef<HTMLDivElement, MainProps>(({ title, sectionId }, ref) => {
    return (
        ...
        >
            <h1 className="font-GmarketSansBold text-6xl">{title}</h1>
            <div className="mt-20 flex items-end text-center font-GmarketSansBold justify-between space-x-20">
                <DeveloperType
                    profiles={[{ nickname: "sooyeoniya" }, { nickname: "ssseok" }]}
                    title="FrontEnd"
                >
                    <p className="mt-10 mb-8 font-GmarketSansLight text-2xl">
